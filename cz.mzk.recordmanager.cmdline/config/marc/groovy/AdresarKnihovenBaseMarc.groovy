...
// facets
function_facet_mv = getFieldsForAdresar("FCEa", SubfieldExtractionMethod.SEPARATED, null)
portal_facet_mv = getPortalFacetMv()
projects_facet_mv = getFieldsForAdresar("PRKa", SubfieldExtractionMethod.SEPARATED, null)
region_disctrict_facet_mv = adresarGetRegionDistrictFacet()
services_facet_mv = getFieldsForAdresar("SLUa", SubfieldExtractionMethod.SEPARATED, null)
type_facet_mv = getFieldsForAdresar "TYPb", SubfieldExtractionMethod.SEPARATED, null
