...
public class ImportAntikvariatyTest extends AbstractTest {
	...
	public void simpleTest() throws Exception {
		...
		Assert.assertEquals(toBeChangedRecord.getCatalogueIds().size(), 1);
		...
		Assert.assertNotNull(toBeChangedRecord.getUpdatedOriginal());
		Assert.assertNotNull(toBeChangedRecord.getLastHarvest());
		...
		Assert.assertEquals(updatedRecord.getCatalogueIds().size(), 1);
		...
		Assert.assertTrue(updatedRecord.getUpdatedOriginal().compareTo(toBeChangedRecord.getUpdatedOriginal()) > 0);
		Assert.assertTrue(updatedRecord.getLastHarvest().compareTo(toBeChangedRecord.getLastHarvest()) > 0);
	}
