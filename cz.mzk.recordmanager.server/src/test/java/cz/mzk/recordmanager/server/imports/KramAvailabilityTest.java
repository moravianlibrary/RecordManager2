...
public class KramAvailabilityTest extends AbstractTest {
	...
	public void metadataHarvestPageTest() throws Exception {
		...
		expect(httpClient.executeGet("https://kramerius.mzk.cz/search/api/v5.0/search?fl=dostupnost,dnnt,PID,level,dnnt-labels,parent_pid,details,document_type&q=document_type:periodicalvolume+dc.identifier:84236100-508e-11e9-918e-5ef3fc9ae867&rows=100&start=0&wt=xml")).andReturn(response0);
		expect(httpClient.executeGet("https://kramerius.mzk.cz/search/api/v5.0/search?fl=dostupnost,dnnt,PID,level,dnnt-labels,parent_pid,details,document_type&q=document_type:periodicalvolume+dc.identifier:84236100-508e-11e9-918e-5ef3fc9ae867&rows=100&start=100&wt=xml")).andReturn(empty0);
		expect(httpClient.executeGet("https://kramerius.mzk.cz/search/api/v5.0/search?fl=dostupnost,dnnt,PID,level,dnnt-labels,parent_pid,details,document_type,issn&q=document_type:periodicalitem+dc.identifier:4df7fb90-50de-11e9-abdc-5ef3fc9bb22f&rows=100&start=0&wt=xml")).andReturn(response1);
		expect(httpClient.executeGet("https://kramerius.mzk.cz/search/api/v5.0/search?fl=dostupnost,dnnt,PID,level,dnnt-labels,parent_pid,details,document_type,issn&q=document_type:periodicalitem+dc.identifier:4df7fb90-50de-11e9-abdc-5ef3fc9bb22f&rows=100&start=100&wt=xml")).andReturn(empty1);
		expect(httpClient.executeGet("https://kramerius.mzk.cz/search/api/v5.0/search?fl=dostupnost,dnnt,PID,level,dnnt-labels,parent_pid,details,document_type,title,rok&q=document_type:page+dc.identifier:01bedf30-513a-11e9-918e-5ef3fc9ae867&rows=100&start=0&wt=xml")).andReturn(response2);
		expect(httpClient.executeGet("https://kramerius.mzk.cz/search/api/v5.0/search?fl=dostupnost,dnnt,PID,level,dnnt-labels,parent_pid,details,document_type,title,rok&q=document_type:page+dc.identifier:01bedf30-513a-11e9-918e-5ef3fc9ae867&rows=100&start=100&wt=xml")).andReturn(empty2);
		replay(httpClient);
