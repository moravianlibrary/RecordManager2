...
<xsl:stylesheet version="1.0"
	...
	<!--
        ...
        MODS v3.5  (Revision 3.03) 20200416
	...
	<xsl:template match="mods:mods">
		<marc:record xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
			...
			<marc:datafield tag="500" ind1=" " ind2=" ">
				<marc:subfield code="a">Converted from MODS 3.6 to MARCXML using MODS3-6_MARC21slim_XSLT1-0.xsl (Revision 3.03 20200416)</marc:subfield>
			</marc:datafield>
