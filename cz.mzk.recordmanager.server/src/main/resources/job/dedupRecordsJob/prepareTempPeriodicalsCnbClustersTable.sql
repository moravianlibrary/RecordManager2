DROP TABLE IF EXISTS tmp_periodicals_cnb_clusters;

CREATE UNLOGGED TABLE tmp_periodicals_cnb_clusters AS
SELECT
...
CREATE INDEX tmp_periodicals_cnb_clusters_idx ON tmp_periodicals_cnb_clusters(row_id);