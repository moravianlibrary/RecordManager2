DROP TABLE IF EXISTS tmp_bl_title_author_ms;

CREATE TABLE tmp_bl_title_author_ms AS
...
WHERE hr.bl_author IS NOT NULL AND dedup_record_id IS NOT NULL AND hrfl.harvested_record_format_id=5
...
CREATE INDEX tmp_bl_title_author_ms_idx ON tmp_bl_title_author_ms(row_id);