DROP TABLE IF EXISTS tmp_bl_title_topic_audio;

CREATE TABLE tmp_bl_title_topic_audio AS
...
CREATE INDEX tmp_bl_title_topic_audio_idx ON tmp_bl_title_topic_audio(row_id);