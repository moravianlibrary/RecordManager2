DROP TABLE IF EXISTS tmp_bl_title_author_audio;

CREATE TABLE tmp_bl_title_author_audio AS
...
CREATE INDEX tmp_bl_title_author_audio_idx ON tmp_bl_title_author_audio(row_id);