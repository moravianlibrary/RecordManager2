DROP TABLE IF EXISTS tmp_bl_title_auth_video;

CREATE TABLE tmp_bl_title_auth_video AS
...
CREATE INDEX tmp_bl_title_auth_video_idx ON tmp_bl_title_auth_video(row_id);