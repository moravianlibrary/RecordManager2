...
INSERT INTO import_conf (id, library_id, contact_person_id, id_prefix, base_weight, cluster_id_enabled, filtering_enabled, interception_enabled, is_library, harvest_frequency, item_id, metaproxy_enabled, ziskej_enabled, mappings996) VALUES (304, 104, 200, 'nkp', 14, true, true, true, true, 'D', 'aleph', true, true, 'aleph');
...
INSERT INTO import_conf (id, library_id, contact_person_id, id_prefix, base_weight, cluster_id_enabled, filtering_enabled, interception_enabled, is_library, harvest_frequency, item_id, metaproxy_enabled, ziskej_enabled, mappings996) VALUES (321, 104, 200, 'nkp', 10, false, true, true, true, 'U', 'aleph', true, false, 'aleph');
...
INSERT INTO import_conf (id, library_id, contact_person_id, id_prefix, base_weight, cluster_id_enabled, filtering_enabled, interception_enabled, is_library, harvest_frequency, item_id, metaproxy_enabled, ziskej_enabled, mappings996) VALUES (325, 104, 200, 'nkp', 11, false, true, true, true, 'U', 'aleph', true, false, 'aleph');
INSERT INTO import_conf (id, library_id, contact_person_id, id_prefix, base_weight, cluster_id_enabled, filtering_enabled, interception_enabled, is_library, harvest_frequency, item_id, metaproxy_enabled, ziskej_enabled, mappings996) VALUES (326, 104, 200, 'nkp', 11, false, true, true, true, 'U', 'aleph', true, false, 'aleph');
...
INSERT INTO import_conf (id, library_id, contact_person_id, id_prefix, base_weight, cluster_id_enabled, filtering_enabled, interception_enabled, is_library, harvest_frequency, item_id, metaproxy_enabled, ziskej_enabled, mappings996) VALUES (330, 130, 200, 'knav', 11, false, true, true, true, 'D', 'aleph', true, true, 'aleph');
...
INSERT INTO import_conf (id, library_id, contact_person_id, id_prefix, base_weight, cluster_id_enabled, filtering_enabled, interception_enabled, is_library, harvest_frequency, ziskej_enabled) VALUES (349, 149, 200, 'muzibib', 11, false, true, true, false, 'U', false);
...
INSERT INTO import_conf (id, library_id, contact_person_id, id_prefix, base_weight, cluster_id_enabled, filtering_enabled, interception_enabled, is_library, harvest_frequency, item_id, ziskej_enabled, mappings996) VALUES (369, 169, 200, 'rkka', 11, false, true, true, true, 'U', 'dawinci', false, 'dawinci');
...
=======
INSERT INTO import_conf (id, library_id, contact_person_id, id_prefix, base_weight, cluster_id_enabled, filtering_enabled, interception_enabled, is_library, harvest_frequency, item_id, mappings996) VALUES (456, 256, 200, 'udumukn', 11, false, true, true, true, 'U', 'aleph', 'aleph');
>>>>>>> gps
...
INSERT INTO oai_harvest_conf (import_conf_id,url,set_spec,metadata_prefix,granularity) VALUES (379,'https://orlova.knihovny.net/tritius/oai-provider','CPK_1','marc21',NULL);
...
INSERT INTO oai_harvest_conf (import_conf_id,url,set_spec,metadata_prefix,granularity) VALUES (381,'https://pisek.knihovny.net/l.dll','CPK','marc21',NULL);
...
INSERT INTO kramerius_conf (import_conf_id,url,query_rows,metadata_stream, fulltext_harvest_type, url_solr, availability_source_url, availability_dest_url) VALUES (99001,'https://kramerius.mzk.cz/',20,'DC','solr','http://kramerius.mzk.cz/solr/select/',null,'https://www.digitalniknihovna.cz/mzk/uuid/');
INSERT INTO kramerius_conf (import_conf_id,url,url_solr,query_rows,metadata_stream,auth_token,fulltext_harvest_type,download_private_fulltexts,harvest_job_name,collection,availability_source_url,availability_dest_url) VALUES (99003,'https://cdk.lib.cas.cz/','https://cdk.lib.cas.cz/solr-select-only/k4',50,'BIBLIO_MODS',null,'solr',true,'krameriusHarvestJob','"vc:c4bb27af-3a51-4ac2-95c7-fd393b489e26"','https://kramerius.lib.cas.cz/','https://kramerius.lib.cas.cz/uuid/');
...
INSERT INTO kramerius_conf (import_conf_id,url,url_solr,query_rows,metadata_stream,auth_token,fulltext_harvest_type,download_private_fulltexts,harvest_job_name,collection,availability_source_url,availability_dest_url) VALUES (99011,'https://cdk.lib.cas.cz/','https://cdk.lib.cas.cz/solr-select-only/k4',50,'BIBLIO_MODS',null,'solr',true,'krameriusHarvestJob','"vc:cd324f70-c034-46f1-9674-e0df4f93de86"','https://kramerius.svkul.cz/','https://kramerius.svkul.cz/search/handle/');
...
INSERT INTO kramerius_conf (import_conf_id,url,url_solr,query_rows,metadata_stream,auth_token,fulltext_harvest_type,download_private_fulltexts,harvest_job_name,collection,availability_source_url,availability_dest_url,dnnt_dest_url) VALUES (99014,'https://cdk.lib.cas.cz/','https://cdk.lib.cas.cz/solr-select-only/k4',50,'BIBLIO_MODS',null,'solr',true,'krameriusHarvestJob','"vc:d34ba74b-026a-4c60-aee7-9250a307952c"','https://kramerius.svkhk.cz/','https://kramerius.svkhk.cz/uuid/','https://kramerius.svkhk.cz/uuid/');
INSERT INTO kramerius_conf (import_conf_id,url,url_solr,query_rows,metadata_stream,auth_token,fulltext_harvest_type,download_private_fulltexts,harvest_job_name,collection,availability_source_url,availability_dest_url) VALUES (99015,'https://cdk.lib.cas.cz/','https://cdk.lib.cas.cz/solr-select-only/k4',50,'BIBLIO_MODS',null,'solr',true,'krameriusHarvestJob','"vc:d4b466de-5435-4b76-bff7-2838bbae747b"','https://kramerius4.mlp.cz/','https://digitalniknihovna.mlp.cz/');
INSERT INTO kramerius_conf (import_conf_id,url,url_solr,query_rows,metadata_stream,auth_token,fulltext_harvest_type,download_private_fulltexts,harvest_job_name,collection,availability_source_url,availability_dest_url) VALUES (99016,'https://cdk.lib.cas.cz/','https://cdk.lib.cas.cz/solr-select-only/k4',50,'BIBLIO_MODS',null,'solr',true,'krameriusHarvestJob','"vc:f750b424-bda4-4113-849a-5e9dbbfb5846"','https://kramerius.techlib.cz/','https://kramerius.techlib.cz/kramerius-web-client/uuid/');
INSERT INTO kramerius_conf (import_conf_id,url,url_solr,query_rows,metadata_stream,auth_token,fulltext_harvest_type,download_private_fulltexts,harvest_job_name,collection,availability_source_url,availability_dest_url) VALUES (99017,'https://cdk.lib.cas.cz/','https://cdk.lib.cas.cz/solr-select-only/k4',50,'BIBLIO_MODS',null,'solr',true,'krameriusHarvestJob','"vc:91a19b3d-8271-4889-8652-6c9d5864bd1b"','https://kramerius.uzei.cz/','https://dk.uzei.cz/uzei/uuid/');
...
INSERT INTO kramerius_conf (import_conf_id,url,url_solr,query_rows,metadata_stream,auth_token,fulltext_harvest_type,download_private_fulltexts,harvest_job_name,collection,availability_source_url,availability_dest_url) VALUES (99019,'https://cdk.lib.cas.cz/','https://cdk.lib.cas.cz/solr-select-only/k4',50,'BIBLIO_MODS',null,'solr',true,'krameriusHarvestJob','"vc:41f345fc-d0ad-11ea-b976-005056b593cd"','https://kramerius.svkos.cz/','https://kramerius.svkos.cz/uuid/');
...
INSERT INTO kramerius_conf (import_conf_id,url,url_solr,query_rows,metadata_stream,auth_token,fulltext_harvest_type,download_private_fulltexts,harvest_job_name,collection,availability_source_url,availability_dest_url) VALUES (99023,'https://cdk.lib.cas.cz/','https://cdk.lib.cas.cz/solr-select-only/k4',50,'BIBLIO_MODS',null,'solr',true,'krameriusHarvestJob','"vc:5af0d476-df3d-4709-8f28-5c33d9d3f4b5"','http://kramerius.kfbz.cz/','http://kramerius.kfbz.cz/uuid/');
...
INSERT INTO kramerius_conf (import_conf_id,url,url_solr,query_rows,metadata_stream,auth_token,fulltext_harvest_type,download_private_fulltexts,harvest_job_name,collection,availability_source_url,availability_dest_url) VALUES (99026,'https://kramerius.knihovna-pardubice.cz/',null,50,'BIBLIO_MODS',null,'solr',true,'krameriusHarvestJob',null,null,'https://kramerius.knihovna-pardubice.cz/uuid/');
...
INSERT INTO kramerius_conf (import_conf_id,url,url_solr,query_rows,metadata_stream,auth_token,fulltext_harvest_type,download_private_fulltexts,harvest_job_name,collection,availability_source_url,availability_dest_url) VALUES (99037,'https://cdk.lib.cas.cz/','https://cdk.lib.cas.cz/solr-select-only/k4',50,'BIBLIO_MODS',null,'solr',true,'krameriusHarvestJob','"vc:9ecedcad-aa68-4967-8d65-f938c5ce3a6b"','https://library.nfa.cz/','https://library.nfa.cz/search/handle/');
...
INSERT INTO kramerius_conf (import_conf_id,url,url_solr,query_rows,metadata_stream,auth_token,fulltext_harvest_type,download_private_fulltexts,harvest_job_name,collection,availability_source_url,availability_dest_url) VALUES (99044,'http://kramerius.zcm.cz/',null,50,'BIBLIO_MODS',null,'solr',true,'krameriusHarvestJob',null,null,'http://kramerius.zcm.cz/search/handle/');
...
INSERT INTO download_import_conf (import_conf_id,url,import_job_name,format) VALUES (495,'local:/data/imports/uep01-cpk','importRecordsJob','xml');
