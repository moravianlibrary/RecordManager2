...
INSERT INTO oai_harvest_conf (import_conf_id,url,set_spec,metadata_prefix,granularity,extract_id_regex,harvest_job_name) VALUES (336,'https://ipac.svkkl.cz/i2/i2.entry.cls','CPK','oai_marcxml_cpk',NULL,'s/[^:]+:[^:]+:[^\\/]+\\/([^\\/]+)/KlUsCat*$1/','cosmotronHarvestJob');
