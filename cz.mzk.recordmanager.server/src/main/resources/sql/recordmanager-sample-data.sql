...
INSERT INTO kramerius_conf (import_conf_id,url,url_solr,query_rows,metadata_stream,auth_token,fulltext_harvest_type,download_private_fulltexts,harvest_job_name,collection,availability_source_url,availability_dest_url,fulltext_version) VALUES (99013,'https://kramerius.cbvk.cz/','https://solr-export.app.ceskadigitalniknihovna.cz/solr/search_v2/',50,'BIBLIO_MODS',null,'solr',true,'krameriusHarvestJob',null,null,'https://kramerius.cbvk.cz/uuid/','7');
...
INSERT INTO kramerius_conf (import_conf_id,url,url_solr,query_rows,metadata_stream,auth_token,fulltext_harvest_type,download_private_fulltexts,harvest_job_name,collection,availability_source_url,availability_dest_url,fulltext_version) VALUES (99024,'https://kramerius.svkkl.cz/','https://solr-export.app.ceskadigitalniknihovna.cz/solr/search_v2/',50,'BIBLIO_MODS',null,'solr',true,'krameriusHarvestJob',null,null,'https://kramerius.svkkl.cz/uuid/', '7');
