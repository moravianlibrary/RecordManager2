...
public class IirMarcInterceptor extends DefaultMarcInterceptor {

	public IirMarcInterceptor(Record record, ImportConfiguration configuration, String recordId) {
