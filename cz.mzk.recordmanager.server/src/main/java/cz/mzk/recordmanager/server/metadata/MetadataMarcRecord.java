...
public class MetadataMarcRecord implements MetadataRecord {
	...
	private static final Pattern DISSERTATION = Pattern.compile("^(?:(?:di[sz]{1,2}ertace|dissertation|di[sz]erta[cč]n[ií]|di[s]{1,2}|kandid[aá]tsk[aá]|doktorsk[aá])\\b)|(?:kand\\.|dokt\\.|doktor\\.|doktorand\\.)", Pattern.CASE_INSENSITIVE | Pattern.UNICODE_CHARACTER_CLASS);
