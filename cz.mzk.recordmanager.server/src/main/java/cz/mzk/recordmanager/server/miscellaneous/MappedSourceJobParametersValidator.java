...
public class MappedSourceJobParametersValidator extends DefaultJobParametersValidator {
	...
	public Collection<JobParameterDeclaration> getParameters() {
		return Collections.singletonList(
				param(Constants.JOB_PARAM_CONF_ID, JobParameter.ParameterType.LONG, true)
		);
	}
