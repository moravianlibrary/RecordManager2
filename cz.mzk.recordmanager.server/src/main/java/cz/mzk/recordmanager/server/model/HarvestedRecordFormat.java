...
public class HarvestedRecordFormat {
	...
	public enum HarvestedRecordFormatEnum {
		...
		THESIS_BACHELOR(69L),
		THESIS_MASTER(70L),
		THESIS_ADVANCED_MASTER(71L),
		THESIS_DISSERTATION(72L),
		THESIS_HABILITATION(73L),
		THESIS_OTHER(74L),
		MUSICAL_SCORES_PRINTED(75L),
		MUSICAL_SCORES_MANUSCRIPT(76L),
		EAUDIOBOOK(77L),
		AUDIO_STREAMING(78L),
		AUDIO_MUSICAL_CASSETTE(79L),
		AUDIO_MUSICAL_CD(80L),
		AUDIO_MUSICAL_DOCUMENTS(81L),
		AUDIO_MUSICAL_DVD(82L),
		AUDIO_MUSICAL_LP(83L),
		AUDIO_MUSICAL_OTHER(84L),
		AUDIO_MUSICAL_STREAMING(85L),
		AUDIO_NONMUSICAL_CASSETTE(86L),
		AUDIO_NONMUSICAL_CD(87L),
		AUDIO_NONMUSICAL_DOCUMENTS(88L),
		AUDIO_NONMUSICAL_DVD(89L),
		AUDIO_NONMUSICAL_LP(90L),
		AUDIO_NONMUSICAL_OTHER(91L),
		AUDIO_NONMUSICAL_STREAMING(92L),
		AUDIO_OTHER_CASSETTE(93L),
		AUDIO_OTHER_CD(94L),
		AUDIO_OTHER_DOCUMENTS(95L),
		AUDIO_OTHER_DVD(96L),
		AUDIO_OTHER_LP(97L),
		AUDIO_OTHER_OTHER(98L),
		AUDIO_OTHER_STREAMING(99L),
